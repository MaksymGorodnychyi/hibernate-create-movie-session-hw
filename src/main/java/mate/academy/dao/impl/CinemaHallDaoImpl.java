...
public class CinemaHallDaoImpl implements CinemaHallDao {
    ...
    public List<CinemaHall> getAll() {
        ...
        try (Session session = sessionFactory.openSession()) {
            Query<CinemaHall> getAllFromCinemaHall = session.createQuery(
                    "from CinemaHall", CinemaHall.class);
            return getAllFromCinemaHall.getResultList();
        } catch (Exception e) {
            throw new DataProcessingException("Can't get all from CinemaHall", e);
        }
    }
}
